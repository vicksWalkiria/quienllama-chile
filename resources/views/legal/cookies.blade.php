...
<div class="content-narrow" style="padding:2rem 0; line-height:1.7; color:#334155">
    ...
    <div style="background:white; border:1px solid var(--border); border-radius:var(--radius-lg); padding:2rem">
        ...
        <p style="margin-bottom:1.5rem">
            Una cookie es un pequeño archivo de texto que se almacena en tu navegador cuando visitás una página web. Permite recordar información sobre tu visita, como preferencias de navegación o medidas de seguridad.
        </p>
        ...
        <p>
            Podés permitir, bloquear o eliminar las cookies instaladas en tu dispositivo mediante la configuración de las opciones de tu navegador (Chrome, Firefox, Safari, Edge). La desactivación de cookies técnicas podría afectar el envío de comentarios o reportes en el sitio.
        </p>
    </div>
</div>
@endsection
