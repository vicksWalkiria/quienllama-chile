...
<div class="about-wrapper" itemscope itemtype="https://schema.org/Person">
    ...
    <div class="about-hero">
        <img src="{{ asset('images/victor-alonso.webp') }}" alt="Víctor Alonso - Desarrollador Full-Stack y Experto SEO" class="about-avatar" itemprop="image">
    ...
    <div class="about-card">
        ...
        <ul>
            ...
            <li><strong>Soporte al marco regulatorio local:</strong> Fomento activo de herramientas oficiales ciudadanas como la plataforma <strong>No Molestar del SERNAC (Ley N° 19.496)</strong> y las normativas de la SUBTEL en Chile.</li>
        </ul>
        ...
        <div class="about-badges">
            <a href="{{ route('contact.index') }}" class="btn btn-primary" style="padding:0.6rem 1.25rem">
