...
@section('title', 'Panel de Métricas Interno - QuiénLlama Chile')
...
<div class="content-tool">
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:2rem">
        <div>
            ...
            <p style="color:var(--text-muted); font-size:0.95rem">Monitoreo interno en tiempo real de QuiénLlama Chile.</p>
        </div>
