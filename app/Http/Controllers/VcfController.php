...
class VcfController extends Controller
{
    ...
    public function download(string $type = 'top-100'): Response
    {
        ...
        foreach ($phones as $p) {
            ...
            $vcfContent .= "TEL;TYPE=CELL,VOICE:+56{$p->number}\r\n";
            $vcfContent .= "NOTE:Reportado como spam en QuiénLlama Chile (cl.quienllama.com.es)\r\n";
        ...
        return response($vcfContent, 200, [
            ...
            'Content-Disposition' => "attachment; filename=\"bloquear_spam_chile_{$type}_{$date}.vcf\"",
        ]);
    }
}
