...
class TelegramAlertService
{
     ...
     */
    public static function sendSpamReport(Phone $phone, Comment $comment, string $countryCode = 'CL', bool $isFastVote = false, string $source = 'Web'): bool
    {
        ...
        $reason = htmlspecialchars($comment->reason ?: 'Llamada molesta');
        $content = htmlspecialchars(mb_strimwidth(strip_tags((string)$comment->content), 0, 500, '...'));
        $location = htmlspecialchars($phone->location ?: 'Chile');
