...
// Páginas informativas y legales adaptadas a Chile
...
Route::get('/descargar-app', function () {
    return redirect('https://play.google.com/store/apps/details?id=com.walkiria.quienllama');
});

// Directorio de Códigos de Área y Prefijos Telefónicos de Chile (SUBTEL)
Route::get('/prefijos', [\App\Http\Controllers\AreaCodeController::class, 'index'])->name('area-codes.index');
Route::get('/prefijo/{code}', [\App\Http\Controllers\AreaCodeController::class, 'show'])->name('area-codes.show');
...
Route::get('/caracteristica/{code}', function ($code) { return redirect()->route('area-codes.show', ['code' => $code], 301); });
